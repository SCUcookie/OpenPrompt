# Setup Directory Guide

This directory contains operational setup notes for the GeoNexus-RSD paper and
experiment workflow.

Use these files:

- `datasets.md`: dataset layout, local/server asset linking, and tracked versus
