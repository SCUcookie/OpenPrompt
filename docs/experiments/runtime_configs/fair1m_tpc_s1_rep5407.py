...
data_root = '/data2/2023/lcs/xyun/FAIR1M_2_800_400_sanitized_20260713/'
...
launcher = 'none'
load_from = 'work_dirs/geonexus_fair1m/roi_trans_s0_rep5407_20260715/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    backbone=dict(
        ...
        frozen_stages=1,
        init_cfg=dict(
            checkpoint='checkpoints/pretrained/resnet50-0676ba61.pth',
            type='Pretrained'),
...
prompt_embedding_path = '/data5/2025/ldh/New/artifacts/generated/remoteclip_vit_b32_fair1m_prompt_embeddings_canonical.pt'
randomness = dict(diff_rank_seed=True, seed=5407)
resume = False
test_cfg = dict(type='TestLoop')
test_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='ss_val/annfiles_sanitized/',
...
work_dir = '/data5/2025/ldh/OpenRSD/work_dirs/geonexus_fair1m/roi_trans_tpc_s1_rep5407_20260717'
