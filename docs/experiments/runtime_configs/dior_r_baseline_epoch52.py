...
launcher = 'none'
load_from = 'work_dirs/dior_r_s0_roi_trans_sanitized_long_20260612_gpu1/epoch_52.pth'
log_level = 'INFO'
...
randomness = dict(deterministic=False, seed=2407)
resume = True
...
train_batch_size = 2
train_cfg = dict(max_epochs=52, type='EpochBasedTrainLoop', val_interval=4)
...
work_dir = 'work_dirs/paper_eval_20260617/dior_r_s0_roi_trans_epoch52'
