...
- GeoNexus S2 hierarchy regularizer 12e completed on the same DOTA v1.5 reduced tiled split. Final epoch 12: `dota/mAP=0.3644`, `dota/AP50=0.3640`; best observed epoch 11: `dota/mAP=0.3652`, `dota/AP50=0.3650`; checkpoint `/data5/2025/ldh/OpenRSD/work_dirs/geonexus_dota15/roi_trans_remoteclip_s2_hierarchy_reg_frozen_12e/epoch_12.pth`; metric summary `docs/experiments/20260601_s2_hierarchy_regularizer_12e_metrics.json`. Treat this as strong positive S2 evidence but still confirm with the active 72e continuation/repeat before final claims.
- S2 hierarchy regularizer 72e continuation is active under `/data5/2025/ldh/OpenRSD/work_dirs/geonexus_dota15/roi_trans_remoteclip_s2_hierarchy_reg_frozen_72e`; at the 2026-06-01 check it had progressed into epoch 68 with finite losses.
...
- `New/queues/geonexus_gpu_queue_20260531.json` has S3 72e reset to `pending` with retry log `/data5/2025/ldh/OpenRSD/work_dirs/geonexus_dota15/roi_trans_remoteclip_s3_scene_adapter_72e/queue_launch_retry_20260601.log`; the existing monitor should launch it when an allowed GPU becomes idle.
